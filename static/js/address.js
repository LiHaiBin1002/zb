...
function getProvince() {
    var oHtml = '<option value="">省/市</option>';
    $.each(city, function (i, v) {
        // console.log(v);
        oHtml += '<option value="' + i + '">' + i + '</option>';
    })
    $("#site").html(oHtml);
    $('#site').searchableSelect();
    $("#site1").html(oHtml);
    $('#site1').searchableSelect();
}
...
function getVal(val) {
    ...
    if(val){
        ...
        $("#city1").html('<option value="">市/区</option>');
    }
}

// function getCounty(cityval) {
    // console.log(cityval);
    // if(cityval == ''){
        // $("#county").html('<option value="">县/镇</option>');
    // } else{
